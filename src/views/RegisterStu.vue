...
<template class="background">
  ...
  <div class="background" style="width: 100%; height: 100%">
    <div class="background-white">
      <div class="stu_title">项目管理/ 信息展示</div>
      <div class="stu_title_two">信息展示</div>
    </div>
      ...
      <div class="search">
        ...
        <div>
          ...
          <el-button
            ...
            >重置</el-button
          >
          <el-button type="small" id="btn-search" @click="dialogFormVisible = true">新建项目</el-button>
        </div>
      </div>
      <!-- 社团风采列表 -->
      <div class="main-list">
              ...
              <div style="padding: 4px">
                <div class="bottom clearfix">
                  ...
                  <div class="list-button">
                    <el-button type="primary" plain @click="Allactive(o)" style="padding: 6% 10%">详情</el-button>

                    <el-button type="danger" plain @click="delmessage(o.ID)" style="padding: 6% 10%">删除</el-button>
                  </div>
                </div>
              </div>
            </el-card>
      ...
      <el-dialog title="社团风采发布" :visible.sync="dialogFormVisible" width="1000px" :before-close="handleClose">
        <el-form :rules="rules" ref="form" :model="form" style="display: flex; justify-content: space-between">
          <div class="r-left-container">
            ...
            <el-form-item label="用户id :" prop="slogan" :label-width="formLabelWidth">
  ...
  methods: {
    ...
    delmessage(val) {
      this.$confirm('确认删除？').then(() => {
        ...
        myAxios('delete', '/clubs/presence', mydata)
          .then((res) => {
    ...
    relmessage() {
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          let mydata = {
            uid: this.form.slogan,
            item_name: this.form.name,
            item_intro: this.form.intro,
            item_img: this.form.imgs,
            equipments: this.form.classes,
          }
          console.log(mydata)
          myAxios('post', '/item/add', mydata)
            .then((res) => {
              console.log(res)
              this.$message({
                showClose: true,
